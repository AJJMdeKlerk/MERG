...
plot "./Energies_statesKept_720_statesAdded_80_maxNRGSteps_615_method_HOSTS.csv" u ($1):($2) w lp lw 1 lc 4 pt 4 t 'HOSTS', "./Energies_statesKept_720_statesAdded_80_maxNRGSteps_615_method_MERG.csv" u ($1):($2) w lp lw 1 lc 3 pt 4 t 'MERG', "./Full.csv" u ($1):($2) w p pt 7 lc -1 t 'Full' 
